// ========== FIX: Added missing showAlert function ==========
        ...
        // ========== TOOLS DATA ==========
        const toolsData = [
            { name: "CSC-style ID Card Maker", desc: "Create professional CSC VLE, employee & student ID cards online.", icon: "fa-id-card", color: "from-red-500 to-rose-600", category: "doc", badge: "Popular", pin: true, img: "", url: "/tools/csc-id-card-maker.html" },
            ...
            { name: "Photo & Signature Resizer", desc: "Resize photo & signature to exam KB and DPI limits.", icon: "fa-signature", color: "from-orange-500 to-amber-600", category: "doc", badge: "", pin: true, img: "/images/photo-sign.webp", url: "/tools/photo-signature-joiner.html" },
            ...
            { name: "GPA / CGPA Calculator", desc: "Convert marks and grades to GPA & CGPA easily.", icon: "fa-graduation-cap", color: "from-blue-500 to-indigo-600", category: "finance", badge: "", pin: false, img: "/images/gpa-cgpa-calculator.webp", url: "/tools/gpa-and-cgpa-calculator.html" },
            ...
            { name: "Photo + Signature Joiner", desc: "Join your photo and signature into a single image.", icon: "fa-object-group", color: "from-cyan-500 to-teal-600", category: "doc", badge: "", pin: false, img: "/images/photo-name-joiner.webp", url: "/tools/photo-signature-joiner.html" },
            ...
            { name: "Image Compressor", desc: "Compress images to small size without quality loss.", icon: "fa-compress", color: "from-teal-500 to-emerald-600", category: "doc", badge: "", pin: false, img: "/images/compress-image.webp", url: "/tools/image-compressor.html" },
            ...
            { name: "PDF to JPG Converter", desc: "Convert PDF pages to high-quality JPG images instantly.", icon: "fa-file-image", color: "from-red-500 to-orange-600", category: "doc", badge: "", pin: false, img: "", url: "/tools/pdf-to-jpg.html" },
            { name: "JPG to PDF Converter", desc: "Convert JPG images to PDF documents quickly and free.", icon: "fa-file-pdf", color: "from-blue-500 to-indigo-600", category: "doc", badge: "", pin: false, img: "", url: "/tools/jpg-to-pdf.html" },
            { name: "Add Watermark to PDF", desc: "Add text or image watermarks to your PDF files online free.", icon: "fa-stamp", color: "from-purple-500 to-indigo-600", category: "doc", badge: "", pin: false, img: "", url: "/tools/add-watermark.html" },
            { name: "Photo Name Joiner", desc: "Combine photo and name text into a single printable image.", icon: "fa-user-tag", color: "from-cyan-500 to-blue-600", category: "doc", badge: "", pin: false, img: "/images/photo-name-joiner.webp", url: "/tools/photo-name-joiner.html" },
            { name: "PAN Card Photo & Sign Resizer", desc: "Resize photo and signature to PAN card application specifications.", icon: "fa-id-card-clip", color: "from-orange-500 to-red-600", category: "doc", badge: "", pin: false, img: "", url: "/tools/pan-card-photo-sign-resizer.html" },
            { name: "Signature Image Resizer", desc: "Resize signature images to exact KB and pixel dimensions for exams.", icon: "fa-pen-nib", color: "from-teal-500 to-cyan-600", category: "doc", badge: "", pin: false, img: "", url: "/tools/signature-resizer.html" },
            { name: "AI Passport Photo Maker", desc: "Create passport-size photos with A4 layout, borders and suit options.", icon: "fa-camera-retro", color: "from-indigo-500 to-purple-600", category: "doc", badge: "NEW", pin: false, img: "", url: "/tools/passport-photo-maker.html" },
            { name: "AI Passport Photo (Google AI)", desc: "Generate passport-ready photos using Google AI Studio prompts.", icon: "fa-robot", color: "from-blue-600 to-violet-600", category: "doc", badge: "AI", pin: false, img: "", url: "/tools/ai-passport-photo-maker.html" },
            { name: "QR Code Generator Pro", desc: "Generate custom QR codes with logo, UPI, WiFi and vCard support.", icon: "fa-qrcode", color: "from-gray-700 to-slate-900", category: "utility", badge: "Pro", pin: false, img: "", url: "/tools/qr-code-generator.html" },
            { name: "Password Generator", desc: "Generate strong, random and secure passwords instantly.", icon: "fa-key", color: "from-yellow-500 to-amber-600", category: "utility", badge: "", pin: false, img: "", url: "/tools/password-generator.html" },
            { name: "Typing Speed Test", desc: "Test your typing speed and accuracy with real-time WPM stats.", icon: "fa-keyboard", color: "from-green-500 to-teal-600", category: "utility", badge: "", pin: false, img: "", url: "/tools/typing-speed-test.html" },
            { name: "Color Picker", desc: "Pick colors and get HEX, RGB and HSL values instantly online.", icon: "fa-palette", color: "from-pink-500 to-rose-600", category: "utility", badge: "", pin: false, img: "", url: "/tools/color-picker.html" },
            { name: "Salary Slip Generator", desc: "Create professional salary slips with auto-calculation and PDF download.", icon: "fa-money-check-alt", color: "from-emerald-500 to-green-600", category: "finance", badge: "NEW", pin: false, img: "", url: "/tools/salary-slip-generator.html" },
            { name: "GST Invoice Generator", desc: "Create GST-ready invoices with auto CGST, SGST and IGST calculation.", icon: "fa-file-invoice-dollar", color: "from-green-600 to-emerald-700", category: "finance", badge: "", pin: false, img: "/images/invoice-generator.webp", url: "/tools/gst-invoice-generator.html" },
            { name: "Multiple ID Card Print", desc: "Print multiple Aadhaar, PAN, Voter ID cards on a single A4 sheet.", icon: "fa-address-card", color: "from-blue-500 to-sky-600", category: "doc", badge: "", pin: false, img: "", url: "/tools/multiple-id-card-print.html" },
            { name: "Notebook Name Sticker Maker", desc: "Create printable notebook name stickers and labels for students.", icon: "fa-tag", color: "from-amber-500 to-yellow-600", category: "utility", badge: "", pin: false, img: "", url: "/tools/notebook-name-sticker.html" },
            { name: "Self Declaration Form", desc: "Generate self-declaration forms for official and academic use as PDF.", icon: "fa-file-contract", color: "from-slate-500 to-gray-700", category: "doc", badge: "", pin: false, img: "", url: "/tools/self-declaration-form.html" },
            { name: "CSC Affidavit Format Generator", desc: "Generate stamp paper affidavit formats for CSC VLE center operations.", icon: "fa-gavel", color: "from-red-600 to-rose-700", category: "doc", badge: "", pin: false, img: "", url: "/tools/csc-affidavit-format-generator.html" },
            { name: "CSC Farmer Registration Portal", desc: "Register farmers through CSC VLE for government schemes online.", icon: "fa-seedling", color: "from-green-600 to-lime-700", category: "utility", badge: "", pin: false, img: "", url: "/tools/csc-farmer-registration.html" },
            { name: "Farmer ID Card Maker", desc: "Create printable Kisan Pehchaan Patra with photo and details.", icon: "fa-tractor", color: "from-lime-500 to-green-600", category: "doc", badge: "", pin: false, img: "/images/farmer-id-card.webp", url: "/tools/farmer-id-card-print.html" },
            { name: "Image to PDF Convertor", desc: "Convert one or more images into a single PDF file.", icon: "fa-file-pdf", color: "from-rose-500 to-red-600", category: "doc", badge: "", pin: true, img: "/images/image-to-pdf.webp", url: "/tools/image-to-pdf.html" },
            { name: "CV Builder", desc: "Create professional Indian-style resumes & CVs with photo and A4 PDF download.", icon: "fa-file-lines", color: "from-rose-500 to-pink-600", category: "utility", badge: "NEW", pin: false, img: "/images/resume-builder.webp", url: "/tools/resume-builder.html" },
            { name: "WhatsApp Image Print Tool", desc: "Print WhatsApp images in proper size and A4 layout for CSC.", icon: "fa-print", color: "from-green-500 to-emerald-600", category: "utility", badge: "", pin: false, img: "", url: "/tools/csc-whatsapp-image-print-tool.html" },
            { name: "WhatsApp Ultimate Tool", desc: "Send WhatsApp messages without saving contacts, generate QR and more.", icon: "fa-comments", color: "from-green-400 to-green-600", category: "utility", badge: "", pin: false, img: "", url: "/tools/whatsapp-ultimate-tool.html" }
        ];
